        ...
        ZStack {
            ...
            VStack(spacing: AppTheme.Spacing.md) {
                ...
                Text(isUnprocessable
                    ? "Voxella Studio loaded this clip's source file but couldn't prepare it for playback. The file may be corrupt or in an unsupported format."
                    : "Voxella Studio couldn't load this clip's source file. It may be missing, on an ejected drive, or unreadable.")
                    .font(.system(size: AppTheme.FontSize.sm))
