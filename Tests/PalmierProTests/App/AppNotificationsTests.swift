...
struct AppNotificationsTests {
    @Test(arguments: [
        (ClipType.video, "2 videos are ready in Voxella Studio."),
        (.audio, "2 audio clips are ready in Voxella Studio."),
        (.image, "2 images are ready in Voxella Studio."),
        (.text, "2 text clips are ready in Voxella Studio."),
        (.lottie, "2 Lottie animations are ready in Voxella Studio."),
        (.sequence, "2 videos are ready in Voxella Studio."),
    ])
